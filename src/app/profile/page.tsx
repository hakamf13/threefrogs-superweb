        ...
        <div className="mx-auto grid max-w-5xl gap-8 lg:grid-cols-[0.9fr_1.1fr]">
          <section className="rounded-[2.5rem] bg-gradient-to-br from-[var(--tf-purple)] via-[var(--tf-purple-dark)] to-[var(--tf-purple)] p-8 text-white shadow-[var(--tf-shadow-card)]">
            ...
            <h1 className="mt-6 text-4xl font-black leading-tight">
              Data akunmu akan dipakai untuk setiap booking
            </h1>

            <p className="mt-4 text-sm leading-7 text-white/85">
              Nama, nomor HP, dan email di halaman ini akan dipakai otomatis
              saat kamu membuat reservasi. Jadi, kamu tidak perlu mengisi ulang
              data pemesan setiap kali booking.
            </p>
            ...
            <div className="mt-8 grid gap-4">
              <div className="rounded-[1.5rem] bg-white/10 p-5 backdrop-blur">
                ...
                <p className="mt-2 text-base font-semibold">
                  Update profil sekali, proses booking jadi lebih ringkas
                </p>
              </div>
              ...
              <div className="rounded-[1.5rem] bg-white/10 p-5 backdrop-blur">
                ...
                <p className="mt-2 text-base font-semibold">
                  Nomor HP dipakai sebagai kontak utama saat reservasi
                </p>
              </div>
              ...
              <div className="rounded-[1.5rem] bg-white/10 p-5 backdrop-blur">
                ...
                <p className="mt-2 text-base font-semibold">
                  Email tetap opsional, tetapi berguna sebagai kontak cadangan
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="rounded-[2.5rem] border border-slate-200 bg-white p-8 shadow-[var(--tf-shadow-card)]">
            <div className="mb-8">
              ...
              <p className="mt-3 text-slate-600">
                Pastikan nama dan nomor HP selalu benar agar booking tercatat
                dengan rapi dan mudah dihubungi bila diperlukan.
              </p>
            </div>
