...
export default async function BookingDetailPage({
	...
	return (
		<>
			...
			<main className="min-h-screen bg-[var(--tf-bg)] px-4 py-10 sm:px-6 lg:px-8">
				<section className="mx-auto max-w-6xl space-y-8">
					<div className="space-y-3">
						...
						<div>
							...
							<h1 className="mt-1 text-3xl font-black tracking-[-0.03em] text-[var(--tf-purple)] md:text-5xl">
								{booking.bookingCode}
							</h1>
						</div>
					</div>
					...
					>
						<div className="flex flex-wrap items-center gap-3">
							<span className="rounded-full bg-white/90 px-3 py-1 text-sm font-semibold">
							...
							<div className={panelClass}>
								...
								{booking.notes ? (
									<div className="mt-5 rounded-2xl bg-[var(--tf-surface-muted)] p-4">
										...
										<p className="mt-2 leading-7 text-slate-800">{booking.notes}</p>
									</div>
								) : null}
							</div>
						...
						<aside className="xl:sticky xl:top-24">
							<div className={`${panelClass} space-y-5`}>
								<div>
									...
									<p className="mt-3 text-4xl font-black tracking-[-0.03em] text-slate-900">
								...
								{showMidtransPendingCard ? (
									<div className="rounded-2xl border border-slate-200 bg-[var(--tf-surface-muted)] p-4">
										...
										<p className="mt-3 text-sm font-medium text-slate-700">
											Midtrans {getPaymentGatewayStatusLabel(booking.paymentGatewayStatus)}
										</p>
										<a
								...
								<div className="rounded-2xl bg-slate-50 p-4 text-xs leading-6 text-slate-600">
									...
									<p>• Booking yang belum dibayar akan otomatis kadaluarsa.</p>
								</div>
							</div>
						</aside>
					</div>
