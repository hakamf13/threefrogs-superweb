		...
		<main className="min-h-screen bg-[var(--tf-bg)] px-6 py-16 text-slate-800">
			<div className="mx-auto max-w-7xl space-y-8">
					...
					<div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
						<div>
							...
							<p className="mt-3 max-w-3xl text-base leading-7 text-slate-600">
								...
								Fokus utamanya: mana yang masih menunggu, mana yang perlu
								perhatian admin, dan mana yang sudah sukses.
							</p>
						</div>
				...
				<section className="grid gap-4 md:grid-cols-2 xl:grid-cols-5">
					...
					<div className={cardClass}>
						<p className="text-sm text-slate-500">Midtrans recent</p>
						...
						<div className="mt-5 space-y-4">
							{gatewayNeedsAttention.length === 0 ? (
								<div className="rounded-[1.25rem] border border-slate-200 bg-slate-50 p-4 text-sm text-slate-600">
									Tidak ada booking Midtrans yang perlu perhatian sekarang.
								</div>
							) : (
					...
					<div className={cardClass}>
						...
						<div className="mt-5 space-y-4">
							{successfulGatewayBookings.length === 0 ? (
								<div className="rounded-[1.25rem] border border-slate-200 bg-slate-50 p-4 text-sm text-slate-600">
									Belum ada booking Midtrans sukses di data terbaru ini.
								</div>
							) : (
				...
				<section className={cardClass}>
					<div className="flex items-center justify-between gap-4">
						<div>
							...
							<h2 className="mt-2 text-2xl font-black text-[var(--tf-purple)]">
								Manual Payment Yang Perlu Dicek
							</h2>
						</div>
